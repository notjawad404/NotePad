...
// Shows the note title only (no description preview).
export default function NoteCard({ note, groupName, onDelete, onRemoveFromGroup }) {
  return (
    <div
      className={`${note.bgColor} ${note.color} p-5 rounded-xl flex flex-col justify-between gap-6 border border-black/5 transition-transform hover:-translate-y-0.5`}
    >
